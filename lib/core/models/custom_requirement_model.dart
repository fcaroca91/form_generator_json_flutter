...
List<CustomRequirement> customRequirementFromJson(String str) => List<CustomRequirement>.from(json.decode(str).map((x) => CustomRequirement.fromJson(x)));

String customRequirementToJson(List<CustomRequirement> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class CustomRequirement {
    ...
    factory CustomRequirement.fromJson(Map<String, dynamic> json) => CustomRequirement(
